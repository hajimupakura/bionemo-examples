...
class DeepSeekAPI:
    def __init__(self):
        #self.api_key = os.getenv("DEEPSEEK_API_KEY", st.secrets.get("DEEPSEEK_API_KEY", ""))
        self.api_key ="sk-4c0c80a4056c412491e08a64523b4945"
    ...
    def generate_response(self, messages: List[Dict], max_tokens: int = 800) -> str:
        payload = {
            "model": "deepseek-chat",
            "messages": messages,
            "temperature": 0.3,
...
class ConversationalMoleculeAnalyzer:
    ...
    def analyze_input_molecule(self, smiles: str) -> str:
        ...
        system_prompt = """You are a pharmaceutical research assistant analyzing molecular structures. 
        Provide detailed, technical analysis focusing on drug development considerations."""
        
        user_prompt = f"""
        Analyze this molecule for drug development potential:
        ...
        - Toxicity: {props['admet']['toxicity']}
        
        Provide analysis covering:
        1. Drug-likeness assessment
        2. ADMET profile implications
        ...
        return self.api.generate_response(messages)
    ...
    def compare_molecules_comprehensive(self, original_smiles: str, new_smiles: str) -> str:
        ...
        system_prompt = """You are a medicinal chemist comparing molecular structures. 
        Provide a technical comparison focusing on drug development parameters."""
        ...
        - Lipinski Violations: {original_props['lipinski_violations']} → {new_props['lipinski_violations']}
        
        ADMET Changes:
        - Absorption: {new_props['admet']['absorption']}
        - Distribution: {new_props['admet']['distribution']}
        - Toxicity: {new_props['admet']['toxicity']}
        
        Analyze:
        1. Drug-like property changes
        2. ADMET profile implications
        3. Therapeutic potential impact
            ...
            if 'selected_molecule' in st.session_state:
                ...
                if validation_results['valid']:
                    ...
                    with st.expander("View Properties", expanded=False):
                        ...
                        st.write(f"- Absorption: {props['admet']['absorption']['caco2_permeability']}")
                        st.write(f"- Distribution: {props['admet']['distribution']['bbb_penetration']}")
                        st.write(f"- Metabolism: {props['admet']['metabolism']['cyp_substrate']}")
                        st.write(f"- Toxicity: {props['admet']['toxicity']['herg_inhibition']}")
